...
% 	DIAGRAMMI DI SEQUENZA PER LE OPERAZIONI
	...
	\begin{figure}
		\centering
		\includegraphics[scale=0.6]{figure/containsKeySD.eps}
		\caption{Diagramma di sequenza per l'operazione di check sulla presenza di una chiave.}\label{fig:containsKeySD}
	\end{figure}

	\begin{figure}
		\centering
		\includegraphics[scale=0.6]{figure/findSD.eps}
		\caption{Diagramma di sequenza per l'operazione di ricerca di una chiave.}\label{fig:findSD}
	\end{figure}

	\begin{figure}
		\centering
		\includegraphics[scale=0.6]{figure/applyDeltasSD.eps}
		\caption{Diagramma di sequenza per l'operazione di applyDeltas().}\label{fig:applyDeltasSD}
	\end{figure}

	\begin{figure}
		\centering
		\includegraphics[scale=0.6]{figure/rootHashSD.eps}
		\caption{Diagramma di sequenza per l'operazione di calcolo del Root Hash.}\label{fig:rootHashSD}
	\end{figure}

	\begin{figure}
		\centering
		\includegraphics[scale=0.6]{figure/getProofSD.eps}
