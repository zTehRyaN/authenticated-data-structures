...
% 	Sezione che illustra l'ottimizzazione per complessita di query su gestione caching
		...
		Dunque, in definitiva, il filtro passato nella query permetterà alla UDF server-side il check se un blocco è presente o meno in cache, e potrà dunque decidere se restituirlo o meno.
