...
%	Introduzione al discorso sulla persistenza, riallacciandosi a ciò che è stato detto nella parte di analisi.
	...
	{DatabaseListener} ---nel caso--> {Discorso su contesto del server}
...
%  	LRU
	...
	{Eventualità di aggiornamento con DatabaseListener o sbirciate su altre cache}
...
% 	DIAGRAMMI DI SEQUENZA PER LE OPERAZIONI
	...
	{Dipendenza dei diagrammi di sequenza dalla soluzione scelta}
