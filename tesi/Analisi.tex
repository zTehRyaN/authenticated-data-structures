...
% 		Introduzione su strutture dati autenticate. Magari breve, e mirata a far comprendere i sucessivi paragrafi
		...
		[IMMAGINE trusted/untrusted presa da appunti]
...
%		sia nella descrizione delle operazioni
	...
	Una skip list autentiticata, come detto, è una particolare implementazione di un ADS, che si basa su skip list, e sulla quale è applicata una funzione crittografica di hash $ h $. Ad ogni nodo dunque sarà associato un valore, e la funzione $ h $ non farà altro che calcolare il root hash di struttura. Quest'ultimo sarà rigidamente dipendente sia dai valori di ogni nodo che dalla loro posizione reciproca. Da questo calcolo sono esclusi i nodi sentinella.
