...
%		sia nella descrizione delle operazioni
	...
	%		teorica, preliminare, e isolata. Qui invece si sottolinea l'aspetto pratico sulla struttura dati.
		...
		[Immagine molto semplice di una skiplist con solo valori in cui si evidenzia la posizione del roothash e il fatto che gli altri confluiscano ad esso, con frecce di flusso]
